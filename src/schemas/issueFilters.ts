...
export const IssueFilterSchema = z
  .object({
    ...
    identifier: z.string().optional().describe("Issue identifier (e.g. ENG-123)"),
    ...
    createdAfter: z.string().optional().describe("Created after date (ISO string)"),
    createdBefore: z.string().optional().describe("Created before date (ISO string)"),
    updatedAfter: z.string().optional().describe("Updated after date (ISO string)"),
    updatedBefore: z.string().optional().describe("Updated before date (ISO string)"),

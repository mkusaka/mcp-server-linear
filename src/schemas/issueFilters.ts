...
const StringComparators = z
  .object({
    ...
    in: z
      .array(z.string())
      .optional()
      .describe("Value is in the given collection of values"),
    nin: z
      .array(z.string())
      .optional()
      .describe("Value is not in the given collection of values"),
    eqIgnoreCase: z.string().optional().describe("Case insensitive equals"),
    neqIgnoreCase: z
      .string()
      .optional()
      .describe("Case insensitive doesn't equal"),
    startsWith: z.string().optional().describe("Starts with the given value"),
    notStartsWith: z
      .string()
      .optional()
      .describe("Doesn't start with the given value"),
    endsWith: z.string().optional().describe("Ends with the given value"),
    notEndsWith: z
      .string()
      .optional()
      .describe("Doesn't end with the given value"),
    contains: z.string().optional().describe("Contains the given value"),
    notContains: z
      .string()
      .optional()
      .describe("Doesn't contain the given value"),
    containsIgnoreCase: z
      .string()
      .optional()
      .describe("Case insensitive contains"),
    notContainsIgnoreCase: z
      .string()
      .optional()
      .describe("Case insensitive doesn't contain"),
  })
  .partial();

const NumberComparators = z
  .object({
    ...
    lte: z
      .number()
      .optional()
      .describe("Less than or equal to the given value"),
    gt: z.number().optional().describe("Greater than the given value"),
    gte: z
      .number()
      .optional()
      .describe("Greater than or equal to the given value"),
  })
  .partial();

const DateComparators = z
  .object({
    ...
    in: z
      .array(z.string())
      .optional()
      .describe("Date is in the given collection of dates"),
    nin: z
      .array(z.string())
      .optional()
      .describe("Date is not in the given collection of dates"),
    lt: z.string().optional().describe("Date is before the given date"),
    lte: z
      .string()
      .optional()
      .describe("Date is before or equal to the given date"),
    gt: z.string().optional().describe("Date is after the given date"),
    gte: z
      .string()
      .optional()
      .describe("Date is after or equal to the given date"),
  })
  .partial();

const BooleanComparators = z
  .object({
    eq: z.boolean().optional().describe("Equals the given boolean value"),
    neq: z
      .boolean()
      .optional()
      .describe("Doesn't equal the given boolean value"),
  })
  .partial();

const NullComparator = z
  .object({
...
export const IssueFilterSchema: z.ZodType<any> = z.lazy(() =>
  z
    .object({
      ...
      project: ProjectFilter.optional().describe(
      ...
      description: StringComparators.optional().describe(
        "Filter by issue description",
      ),
      identifier: StringComparators.optional().describe(
        "Filter by issue identifier",
      ),
      priority: NumberComparators.optional().describe(
        "Filter by issue priority (1-4)",
      ),
      estimate: NumberComparators.optional().describe(
        "Filter by issue estimate",
      ),

      createdAt: DateComparators.optional().describe("Filter by creation date"),
      updatedAt: DateComparators.optional().describe(
        "Filter by last update date",
      ),
      completedAt: DateComparators.optional().describe(
        "Filter by completion date",
      ),
      dueDate: DateComparators.optional().describe("Filter by due date"),

      isBlocked: BooleanComparators.optional().describe(
        "Filter by blocked status",
      ),
      isBlocker: BooleanComparators.optional().describe(
        "Filter by blocker status",
      ),

      or: z
        .array(z.lazy(() => IssueFilterSchema))
        .optional()
        .describe("Logical OR operator for alternative conditions"),
      and: z
        .array(z.lazy(() => IssueFilterSchema))
        .optional()
        .describe("Logical AND operator for combined conditions"),
      not: z
        .lazy(() => IssueFilterSchema)
        .optional()
        .describe("Logical NOT operator to negate a condition"),
    })
    .partial(),
);

...
import { CreateIssueSchema, DeleteIssueSchema, UpdateIssueEstimateSchema, UpdateIssueLabelsSchema, UpdateIssuePrioritySchema, UpdateIssueSchema, UpdateIssueStateSchema } from "../schemas/issues.js";
...
export const updateIssueTool: ToolCallback<typeof UpdateIssueSchema.shape> = async (args, extra) => {
  const client = getLinearClient();
  try {
...
export const deleteIssueTool: ToolCallback<typeof DeleteIssueSchema.shape> = async (args, extra) => {
  const client = getLinearClient();
  try {
    const issue = await client.issue(args.issueId);
    if (!issue) {
...
export const updateIssueLabelsTool: ToolCallback<typeof UpdateIssueLabelsSchema.shape> = async (args, extra) => {
  const client = getLinearClient();
  try {
    const issue = await client.issue(args.issueId);
    if (!issue) {
...
export const updateIssuePriorityTool: ToolCallback<typeof UpdateIssuePrioritySchema.shape> = async (args, extra) => {
  const client = getLinearClient();
  try {
    const issue = await client.issue(args.issueId);
    if (!issue) {
...
export const updateIssueEstimateTool: ToolCallback<typeof UpdateIssueEstimateSchema.shape> = async (args, extra) => {
  const client = getLinearClient();
  try {
    const issue = await client.issue(args.issueId);
    if (!issue) {
...
export const updateIssueStateTool: ToolCallback<typeof UpdateIssueStateSchema.shape> = async (args, extra) => {
  const client = getLinearClient();
  try {
    const issue = await client.issue(args.issueId);
    if (!issue) {
